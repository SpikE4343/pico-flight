...
#ifndef gyro_spi_mpu9250_INCLUDED
#define gyro_spi_mpu9250_INCLUDED
...
enum {
  GYRO_ST_BOOT=0,
  GYRO_ST_CAL_COLLECT=10,
  GYRO_ST_CAL_COMPLETE=11,
  GYRO_ST_READY=20,
  GYRO_ST_FAIL=255
};
...
typedef struct
{
  ...
  uint8_t movementThreshold;
  uint8_t maxRetries;
} GyroCalibrationConfig_t;


typedef void (*gyro_update_complete_callback_t)();
